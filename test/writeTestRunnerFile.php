...
if ($errorCount) {
    ...
    $htmlString .= '<script src="http://cdnjs.cloudflare.com/ajax/libs/headjs/0.99/head.min.js"></script>
            <script type="text/javascript">
                head.js('

        . '"' . implode('", "', $scriptsToLoad) . '"' //include scripts specified in config file
